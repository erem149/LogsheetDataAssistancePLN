...
class MyNavigationActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Sistem Navigasi Maps"
...
// Drawing polyline in the Google Map for the i-th route
    ...
    private fun getDirectionsUrl(origin: LatLng, dest: LatLng): String? {
        ...
        return "https://maps.googleapis.com/maps/api/directions/$output?$parameters&key=AIzaSyA2QCvZDFyhfen_emEtRGWEf0C4q_8TgeI"
    }
